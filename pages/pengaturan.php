...
<body>
    ...
    <div id="main-wrapper">
                ...
                <div class="row">
                        ...
                        <div class="card shadow-sm border-0" style="border-radius: 15px;">
                            <div class="card-body p-3">
                                ...
                                <div class="nav flex-column nav-pills settings-nav" id="v-pills-tab" role="tablist">
                                    <button class="nav-link active text-start" data-bs-toggle="pill" data-bs-target="#tab-item-group"><i class="la la-box"></i> Produk & Ukuran</button>
                                    ...
                                    <button class="nav-link text-start" data-bs-toggle="pill" data-bs-target="#tab-user"><i class="la la-user-lock"></i> Akses Pengguna</button>
                                    ...
                                    <button class="nav-link text-start" data-bs-toggle="pill" data-bs-target="#tab-template"><i class="la la-clipboard-list"></i> Template Cetak Mobile</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="tab-content">
                            ...
                            <!-- TAB: PRODUK & UKURAN -->
                            <div class="tab-pane fade show active" id="tab-item-group">
                            ...
                            <div class="tab-pane fade" id="tab-template">
                                <div class="card content-card shadow-sm">
                                    <div class="card-header border-0 d-flex justify-content-between align-items-center">
                                        <h4 class="card-title text-black">Master Template Mobile</h4>
        ...
        <div class="modal fade" id="modalTemplate" tabindex="-1" aria-hidden="true"><div class="modal-dialog modal-dialog-centered"><div class="modal-content border-0 shadow-lg"><form id="formTemplate">
            <div class="modal-header bg-primary text-white border-0"><h5>Data Template Mobile</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div>
            <div class="modal-body p-4">
                <input type="hidden" name="id" id="template_id">
                <div class="mb-3"><label class="font-w600 small">Nama Template</label><input type="text" name="template_name" id="template_name" class="form-control" required></div>
                <div class="row g-2 mb-3">
                    <div class="col-6"><label class="font-w600 small">Item</label><input type="text" name="item" id="template_item" class="form-control" required></div>
                    <div class="col-3"><label class="font-w600 small">Size</label><input type="text" name="size" id="template_size" class="form-control" required></div>
                    <div class="col-3"><label class="font-w600 small">Unit</label><input type="text" name="unit" id="template_unit" class="form-control" required></div>
                </div>
                <div class="row g-2 mb-2">
                    <div class="col-6"><label class="font-w600 small">Mesin</label><input type="text" name="machine" id="template_machine" class="form-control" required></div>
                    <div class="col-6"><label class="font-w600 small">Shift</label><input type="text" name="shift" id="template_shift" class="form-control" required></div>
                    <div class="col-12 mt-2"><label class="font-w600 small">Isi/Kapasitas (Qty)</label><input type="text" name="quantity" id="template_quantity" class="form-control" required></div>
                </div>
            </div>
    ...
    <script>
        window.loadMasterData = async function() {
            const types = ['item', 'machine', 'user', 'unit', 'pin', 'size', 'quantity', 'shift', 'template'];
            let allData = {};
            ...
            renderTable('template', allData.template);
        }

        // Auto-Polling Master Data (5 detik agar server tidak berat tapi tetap sync)
        setInterval(() => {
        ...
        async function handleAJAXSave(e, type, modalId) {
            ...
            if((await res.json()).status === 'success') { bootstrap.Modal.getInstance(document.getElementById(modalId)).hide(); toastr.success('Success'); loadMasterData(); }
        }
        ...
        window.openTemplateModal = (data=null) => { 
            ...
            if(data) { 
                ...
                document.getElementById('template_item').value = data.item; 
                document.getElementById('template_size').value = data.size; 
                document.getElementById('template_unit').value = data.unit; 
                document.getElementById('template_machine').value = data.machine; 
                document.getElementById('template_shift').value = data.shift; 
